...
class BrickBreak:
	...
	def show_stats(self):
		if self.font:
			font_surface = self.font.render("PRESS Q TO QUIT     LEVEL: " + str(self.level + 1) + " SCORE: " + str(self.score) + " LIVES: " + str(self.lives), False, WHITE)
			self.screen.blit(font_surface, (60, 5))
